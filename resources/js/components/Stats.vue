...
const projects = [
    { name: 'Total Users', initials: 'TU', href: '#', members: 16, bgColor: 'bg-pink-600' },
    { name: 'Ressourses', initials: 'Res', href: '#', members: 12, bgColor: 'bg-purple-600' },
    { name: 'Categories', initials: 'Cat', href: '#', members: 16, bgColor: 'bg-yellow-500' },
    { name: 'Reports', initials: 'Re', href: '#', members: 8, bgColor: 'bg-green-500' },
]
